...
const MainPortfolio = () =>{
    ...
    return(
        ...
        <div className='p-3 sm:grid-cols-2 gap-4  sm:translate-x-0 sm:grid grid mx-auto items-center  sm:mx-40 sm:my-6 justify-items-center grid-cols-1'>
            <div className='border-2 w-72 sm:w-96 sm:h-full sm:p-3 mb-4 border-blue-200 p-2 rounded-lg'>
                ...
                <div className='flex-wrap sm:flex-nowrap flex gap-3 items-center mb-8 sm:mt-10'>           
