...
const MainPortfolio = () =>{
    ...
    return(
        ...
        <div className='p-3 sm:grid-cols-2 gap-4 text-white sm:translate-x-0 sm:grid grid mx-auto items-center  sm:mx-40 sm:my-6 justify-items-center grid-cols-1'>
            ...
            <div className='border-2 w-72 sm:w-96 sm:h-full sm:p-3 mb-4 border-blue-200 p-2 rounded-lg'>
                ...
                <p className='mt-6 font-bold bg-[#17191c] p-2 shadow-md rounded-xl'>SheriffYouTube is a video site portfolio and YouTube alike method. access to search for video and watch</p>
                <div className='flex-wrap sm:flex-nowrap flex gap-3 items-center mb-3 sm:mt-10'>            
            ...
            <div className='border-2 w-72 sm:w-96 sm:h-full sm:p-3 mb-4 border-blue-200 p-2 rounded-lg'>
                ...
                <p className='mt-6 font-bold bg-[#17191c] p-2 shadow-md rounded-xl'>SheriffShipment is a shipment site portfolio and transportation platform. ideas of giving Transportation from one port to another either within the coutry or outside the country.</p>
                <div className='flex-wrap sm:flex-nowrap flex gap-3 items-center mb-3 sm:mt-10'>            
            ...
            <div className='border-2 w-72 sm:w-96 mb-4 mt-4 sm:h-full sm:p-3 border-blue-200 p-2 rounded-lg'>
                ...
                <p className='mt-6 font-bold bg-[#17191c] p-2 shadow-md rounded-xl'>Api fetch of a thecatapi return a Array of 10 ramdom cat image and implement pagination of displaying more images by modifying the limit parameter and Add a button to "Save to Favorite"</p>
                <div className='flex-wrap sm:flex-nowrap flex gap-3 items-center mb-3 sm:mt-10'>            
            ...
            <div className='border-2 w-72 sm:w-96 mb-4 mt-4 sm:h-full sm:p-3 border-blue-200 p-2 rounded-lg'>
                ...
                <p className='mt-6 font-bold bg-[#17191c] p-2 shadow-md rounded-xl'>SheriffBlog is a blog site portfolio and facebook a like method. access to posts watch video and view market</p>
                <div className='flex-wrap sm:flex-nowrap flex gap-3 items-center mb-3 sm:mt-10'>            
            ...
            <div className='border-2 w-72 sm:w-96 mb-4 mt-4 sm:h-full sm:p-3 border-blue-200 p-2 rounded-lg'>
                ...
                <button className='hover:bg-[#dedee0] border-2 border-blue-400 p-1 mt-32 rounded-xl w-32 mb-3 font-bold '>
                    Live
                </button>
                </Link>
            </div>
